...
import com.lucasbrandao.mycryptolist.models.dto.CredentialsDTO;
...
public class JWTAuthFilter extends UsernamePasswordAuthenticationFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res) throws AuthenticationException {
		try {
			...
			UsernamePasswordAuthenticationToken usernamePasswordAuthenticationToken = 
					new UsernamePasswordAuthenticationToken(credentialsDto.getUsername(), credentialsDto.getPassword(), new ArrayList<>());
	...
	public void successfulAuthentication(HttpServletRequest req, HttpServletResponse res, FilterChain chain, Authentication auth) 
		...
		res.addHeader("Authorization", "Bearer " + jwtUtil.generateToken(((UserAuthentication) auth.getPrincipal()).getNome()));
	}
}